...
- [x] Apply basic layout styles (container, typography, colors)
...
- [x] Create `ShiftSetupComponent`
- [x] Create `ShiftFormModalComponent`
- [x] Display default day requirements (Min/max Nurses & RAs, Max total staff)
- [x] Display default night requirements
- [x] Add edit functionality for requirements
- [x] Add live validation:
    - [x] maxTotalStaff ≥ minNurses + minRAs
    - [x] min values ≤ max values
- [x] Integrate with `ShiftConfigService`
...
- Shift configuration functionality complete:
    - ShiftSetupComponent with requirements table
    - ShiftFormModalComponent for editing
